...
g_caffe_install_path = os.path.abspath('/home/sjxy/caffe/build/tools/caffe') # [take care!!!]
g_matlab_executable_path = os.path.abspath('/usr/local/MATLAB/R2014b/bin/matlab') # [take care!!!]
...
#g_shapenet_synset_set = ['04379243'] # table,night table
#g_shapenet_synset_set = ['03636649'] # lamp
#g_shapenet_synset_set = ['02958343'] # car
#g_shapenet_synset_set = ['02691156'] # airplane
#g_shapenet_synset_set = ['04256520'] # sofa
g_shapenet_synset_set = ['02871439'] # bookshelf
#g_shapenet_synset_set = ['02818832'] # bed
...
'04256520': [x*18 for x in range(0,20)],
'02871439': [x*18 for x in range(0,20)],
'02818832': [x*18 for x in range(0,20)]
...
g_view_distribution_params['04256520'] = [[93, 90, 79, 66, 56, 49, 45, 44, 45, 46, 48, 51, 56, 63, 75, 87],[1, 1, 1, 1, 1, 1, 1, 23, 57, 212, 315, 181, 80, 36, 26, 21, 18, 20],3]
g_view_distribution_params['02871439'] = [[93, 90, 79, 66, 56, 49, 45, 44, 45, 46, 48, 51, 56, 63, 75, 87],[1, 1, 1, 1, 1, 1, 1, 23, 57, 212, 315, 181, 80, 36, 26, 21, 18, 20],3]
g_view_distribution_params['02818832'] = [[93, 90, 79, 66, 56, 49, 45, 44, 45, 46, 48, 51, 56, 63, 75, 87],[1, 1, 1, 1, 1, 1, 1, 23, 57, 212, 315, 181, 80, 36, 26, 21, 18, 20],3]
