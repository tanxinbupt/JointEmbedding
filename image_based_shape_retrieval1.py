...
#sorted_distances = sorted([(sum((image_embedding-shape_embedding)**2), idx) for idx
...
for i in range(args.top_k):
    ...
    Path=('/home/sjxy/JointEmbedding/data/image_embedding/syn_images/'+synset+'/'+md5_id)
...
"""
     <div class="retrieval">
	    ...
	    <img class="item" src="%s" title="%s/%s">
	    <div class="property">
		<p>id: %s</p>
	    </div>
	</div>
 """%(Pathname, synset, md5_id, md5_id)
